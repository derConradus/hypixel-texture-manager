...
public class IndexUpdaterPlain {
    ...
    public static void main(String[] args) {
        ...
        String basisOrdnerPfad = "/home/kalle/Dokumente/GitHub/hypixel-texture-manager/backend/resourcepacks"; // Basisordner

        Map<String, Map<String, String>> vorhandeneIDs = new TreeMap<>();
